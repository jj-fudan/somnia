...
class SOMNIA_cacc_Tests2 (c:SOMNIA_cacc) extends PeekPokeTester(c){
...
class SOMNIA_cacc_Tester2 extends ChiselFlatSpec{
  ...
  backends foreach{ backend =>
     ...
     it should s"correctly $backend" in{
        ...
        implicit val conf: somniaConfig = new somniaConfig
         ...
         Driver(() => new SOMNIA_cacc())(c => new SOMNIA_cacc_Tests2(c)) should be (true)
